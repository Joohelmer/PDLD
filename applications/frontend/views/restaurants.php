...
<main id="content">
        ...
        <div class="filariane">
            ...
            Vous êtes ici :
                ...
                <li itemscope="" itemtype="http://data-vocabulary.org/Breadcrumb">
                    <a title="Se restaurer" href="<?php echo base_url('restaurants'); ?>" itemprop="url">
                        <span itemprop="title">Se restaurer</span>
                    </a>
                </li>  
                <?php if($this->uri->segment(3) && !is_numeric ($this->uri->segment(3))){  ?> 
                    <li itemscope="" itemtype="http://data-vocabulary.org/Breadcrumb">
                        <a title="Restaurants à <?= $this->uri->segment(3) ?>" href="<?php echo $_SERVER['REQUEST_URI']; ?>" itemprop="url">
                            <span itemprop="title">Restaurants à <?= $this->uri->segment(3) ?></span>
                        </a>
                    </li> 
                <?php } ?>
            </ol>            
...
<script type="text/javascript">
    ...
    <?php if($restaurants){ ?>
        var markers = <?php echo json_encode($restaurants); ?>;
    <?php } ?>
